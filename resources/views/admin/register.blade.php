	...
	<div class="login_box">
		...
		<div class="form">
			<form action="" method="post">
				...
				<ul>
					<li>
						<input type="text" name="name" class="text" placeholder="请输入昵称1-10位" value="{{ old('name') }}"/>
					...
					<li>
						<input type="password" name="password_re" class="text" placeholder="再次确认密码" value="{{ old('password') }}"/>
						<span><i class="fa fa-lock"></i></span>
					</li>
					<li>
			...
			<div style="margin-left: 0%; width: 240px;">
				<input type="button" value="已有账号？立即登陆" style="width: 240px" onclick="window.location.href='{{route('viewLogin')}}'"/>
			</div>

			<p><a href="#">返回首页</a>
				&copy; 2016 Powered by <a href="http://www.houdunwang.com" target="_blank">http://www.houdunwang.com</a>
			</p>
		</div>
	</div>
	<script>
